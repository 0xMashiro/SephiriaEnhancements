    ...
    internal static class MapNavigationLocalization
    {
            ...
            IEnumerable<string> languages)
        {
            Configuration.LocalizationGroup.Register(add, languages,
                new[] { People, Places, Fit, Travel, Empty, Browse, Guide, PanGuide, Track, Untrack, RoomTravel, Rooms, SelectRoomGuide, Home, Weapons, Departure, MultiplayerGate, Tree, DestinationTravel, TravelUnavailable, MapNotReady, NoLanding, TownReturnPortal, ChooseTarget, ChooseTargetGuide, PointerGuide }, Texts);
        }
    }
}
