...
internal static class InventoryHardConstraintChecks
{
    ...
    private static void EditingAndPersistence()
    {
        ...
        Check(!InventoryOptimizationPreferencesCodec.TryDecode("v7\nO|0|1\nC|ICE|1|2|99", InventorySearchEffort.Fast, true, out _),
    ...
    private static void PersistentRulesRemainVisibleAndRemovable()
    {
        ...
        var oldIntent = LocalPlayerInventoryIntentStore.Capture();
        try
        {
            ...
            LocalPlayerInventoryIntentStore.Replace(Queue(board));
            LocalPlayerInventoryIntentStore.RestorePersistentCombos();
            var restored = LocalPlayerInventoryIntentStore.Capture();
            ...
            restored = LocalPlayerInventoryIntentStore.Capture();
            ...
            LocalPlayerInventoryIntentStore.Clear();
            Check(InventoryComboTargetEditor.BuildTargets(board, LocalPlayerInventoryIntentStore.Capture()).Count == 0 &&
                Solve(board, LocalPlayerInventoryIntentStore.Capture(), true).Succeeded,
        ...
        finally
        {
            ...
            LocalPlayerInventoryIntentStore.Replace(oldIntent);
        }
    }
