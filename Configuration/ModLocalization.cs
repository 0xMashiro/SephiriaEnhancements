        ...
        private static readonly Dictionary<string, Dictionary<string, string>> SuiteTexts =
            new Dictionary<string, Dictionary<string, string>>
            {
                ["en-US"] = Q("Sephiria Enhancements",
                    "Enable or disable all Mod features. Hover over or select a setting for help. Rebind Mod shortcuts in the game's keyboard or gamepad settings; follow the current controls shown in each feature.",
                    "Combat companion",
                ...
                ["zh-CN"] = Q("Sephiria 增强",
                    "启用或停用全部 Mod 功能。悬停或选中设置可查看说明；在游戏键盘或手柄设置中修改 Mod 快捷键，具体操作以各界面的当前按键提示为准。", "战斗伙伴",
                    "“仅单机”只在离线游戏中启用；“智能补位”还会在多人游戏中房主独自游戏时陪伴，并在真人加入后脱战离队；“房主始终启用”会在多人队伍中保留伙伴。不占玩家位置，其他玩家无需安装本 MOD。",
                    "仅单机", "智能补位", "房主始终启用", "关闭", "开启"),
                ["zh-TW"] = Q("Sephiria 增強",
                    "啟用或停用全部 Mod 功能。懸停或選取設定可查看說明；在遊戲鍵盤或手把設定中修改 Mod 快捷鍵，具體操作以各介面的目前按鍵提示為準。", "戰鬥夥伴",
                ...
                ["ko-KR"] = Q("Sephiria Enhancements",
                    "Mod의 모든 기능을 켜거나 끕니다. 설정에 마우스를 올리거나 선택하면 도움말이 표시됩니다. 게임의 키보드 또는 게임패드 설정에서 Mod 단축키를 변경하고 각 화면의 현재 조작 안내를 따르세요.",
                    "전투 동료",
                ...
                ["ja-JP"] = Q("Sephiria Enhancements",
                    "Mod の全機能を有効または無効にします。設定にカーソルを合わせるか選択すると説明が表示されます。Mod のショートカットはゲームのキーボード・ゲームパッド設定で変更できます。各画面の現在の操作表示に従ってください。",
                    "戦闘の仲間",
                ...
                ["de-DE"] = Q("Sephiria Enhancements",
                    "Aktiviert oder deaktiviert alle Mod-Funktionen. Für Hilfe eine Einstellung mit dem Mauszeiger berühren oder auswählen. Mod-Tasten lassen sich in den Tastatur- oder Gamepad-Einstellungen ändern; die jeweilige Ansicht zeigt die aktuelle Belegung.",
                    "Kampfbegleiter",
                ...
                ["es-ES"] = Q("Sephiria Enhancements",
                    "Activa o desactiva todas las funciones del Mod. Pasa el cursor sobre un ajuste o selecciónalo para ver la ayuda. Cambia los atajos del Mod en los ajustes de teclado o mando; sigue las indicaciones actuales de cada pantalla.",
                ...
                ["fr-FR"] = Q("Sephiria Enhancements",
                    "Active ou désactive toutes les fonctions du Mod. Survolez ou sélectionnez un réglage pour afficher son aide. Modifiez les raccourcis du Mod dans les réglages clavier ou manette ; suivez les commandes affichées dans chaque écran.",
                    "Compagnon de combat",
                ...
                ["it-IT"] = Q("Sephiria Enhancements",
                    "Attiva o disattiva tutte le funzioni del Mod. Passa il cursore su un'impostazione o selezionala per leggere l'aiuto. Cambia le scorciatoie del Mod nelle impostazioni di tastiera o gamepad; segui i comandi mostrati nelle varie schermate.",
                ...
                ["pl-PL"] = Q("Sephiria Enhancements",
                    "Włącza lub wyłącza wszystkie funkcje moda. Najedź na ustawienie lub wybierz je, aby przeczytać pomoc. Skróty moda zmienisz w ustawieniach klawiatury lub pada; korzystaj z aktualnych podpowiedzi na poszczególnych ekranach.",
                    "Towarzysz walki",
                ...
                ["pt-BR"] = Q("Sephiria Enhancements",
                    "Ativa ou desativa todos os recursos do Mod. Passe o cursor sobre uma opção ou selecione-a para ver a ajuda. Altere os atalhos do Mod nas configurações de teclado ou controle; siga os comandos atuais de cada tela.",
                ...
                ["ru-RU"] = Q("Sephiria Enhancements",
                    "Включает или отключает все функции мода. Наведите указатель на настройку или выберите её для справки. Меняйте сочетания клавиш мода в настройках клавиатуры или геймпада; следуйте текущим подсказкам на каждом экране.",
                    "Боевой спутник",
                ...
                ["sv-SE"] = Q("Sephiria Enhancements",
                    "Aktiverar eller stänger av alla modfunktioner. Håll pekaren över eller välj en inställning för hjälp. Ändra moddens genvägar i spelets tangentbords- eller handkontrollsinställningar; följ de aktuella knappanvisningarna i varje vy.",
                    "Stridsföljeslagare",
                ...
                ["th-TH"] = Q("Sephiria Enhancements",
                    "เปิดหรือปิดคุณสมบัติทั้งหมดของ Mod วางเมาส์เหนือการตั้งค่าหรือเลือกเพื่ออ่านคำอธิบาย เปลี่ยนปุ่มลัดของ Mod ได้ในการตั้งค่าแป้นพิมพ์หรือเกมแพดของเกม และใช้ปุ่มตามคำแนะนำปัจจุบันในแต่ละหน้าจอ",
                    "เพื่อนร่วมรบ",
                ...
                ["tr-TR"] = Q("Sephiria Enhancements",
                    "Tüm Mod özelliklerini açar veya kapatır. Yardım için bir ayarın üzerine gelin veya ayarı seçin. Mod kısayollarını oyunun klavye veya kontrolcü ayarlarından değiştirin; her ekranda gösterilen güncel tuşları kullanın.",
                    "Savaş yoldaşı",
