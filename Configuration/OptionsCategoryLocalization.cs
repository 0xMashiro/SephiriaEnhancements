...
namespace SephiriaEnhancements.Configuration
{
    ...
    internal static class OptionsCategoryLocalization
    {
        ...
        private static readonly Dictionary<string, string[]> Texts = new()
        {
            ...
            ["ko-KR"] = new[] { "설정 분류", "아래에 표시할 Sephiria Enhancements 설정 분류를 선택합니다.", "일반", "전투 및 표시", "조작 및 카메라", "멀티플레이" },
            ["ja-JP"] = new[] { "設定カテゴリ", "下に表示する Sephiria Enhancements の設定カテゴリを選びます。", "基本", "戦闘と表示", "操作とカメラ", "マルチプレイ" },
            ["de-DE"] = new[] { "Einstellungskategorie", "Wählt die unten angezeigte Einstellungsgruppe von Sephiria Enhancements.", "Allgemein", "Kampf und Anzeige", "Steuerung und Kamera", "Mehrspieler" },
            ...
            ["it-IT"] = new[] { "Categoria impostazioni",
                    ...
                    "Multigiocatore" },
            ["pl-PL"] = new[] { "Kategoria ustawień", "Wybierz grupę ustawień Sephiria Enhancements wyświetlaną poniżej.", "Ogólne", "Walka i wyświetlanie", "Sterowanie i kamera", "Tryb wieloosobowy" },
            ["pt-BR"] = new[] { "Categoria de configurações",
                    ...
                    "Controles e câmera",
                    "Multijogador" },
            ["ru-RU"] = new[] { "Категория настроек", "Выберите группу настроек Sephiria Enhancements для отображения ниже.", "Общие", "Бой и отображение", "Управление и камера", "Сетевая игра" },
            ["sv-SE"] = new[] { "Inställningskategori", "Välj vilken grupp av inställningar för Sephiria Enhancements som visas nedan.", "Allmänt", "Strid och visning", "Kontroller och kamera", "Flerspelarläge" },
            ["th-TH"] = new[] { "หมวดการตั้งค่า", "เลือกหมวดการตั้งค่า Sephiria Enhancements ที่จะแสดงด้านล่าง", "ทั่วไป", "การต่อสู้และการแสดงผล", "การควบคุมและกล้อง", "ผู้เล่นหลายคน" },
            ["tr-TR"] = new[] { "Ayar kategorisi", "Aşağıda gösterilecek Sephiria Enhancements ayar grubunu seçin.", "Genel", "Savaş ve görünüm", "Kontroller ve kamera", "Çok oyunculu" }
        };
