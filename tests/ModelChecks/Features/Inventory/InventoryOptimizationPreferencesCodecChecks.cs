    ...
    internal static string Run()
    {
        var source = new InventoryOptimizationPreferences(InventorySearchEffort.Thorough, false,
            ...
            new[]
            {
                ...
                new ComboOptimizationPreference("WARD", InventoryPreferenceLevel.Avoid, 0, InventoryConstraintStrength.Hard)
            });
        ...
        if (!InventoryOptimizationPreferencesCodec.TryDecode("v7\nO|0|1", InventorySearchEffort.Balanced, true, out var empty) ||
