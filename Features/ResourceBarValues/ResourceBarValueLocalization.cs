    ...
    internal static class ResourceBarValueLocalization
    {
        ...
        private static readonly Dictionary<string, string[]> Texts = new Dictionary<string, string[]>
        {
            ["en-US"] = new[] {
                ...
                "Miniboss super armor numbers", "Show current / maximum super armor beside miniboss bars when the native super armor bar is visible. Off by default.",
                "Boss health numbers", "Show health and shield numbers on boss bars, including separate parts. On by default.",
                "Boss super armor numbers", "Show current / maximum super armor below boss bars, including separate parts, while super armor is active. Off by default.",
            ...
            ["zh-CN"] = new[] {
                ...
                "小 BOSS 超级护甲数值", "当原有超级护甲条可见时，在小 BOSS 血条旁显示超级护甲当前值 / 上限。默认关闭。",
                "BOSS 生命数值", "显示 BOSS 血条的生命与护盾数值，包含独立部位。默认开启。",
                "BOSS 超级护甲数值", "存在超级护甲时，在 BOSS 血条下方显示当前值 / 上限，包含独立部位。默认关闭。",
            ...
            ["zh-TW"] = new[] {
                ...
                "小 BOSS 超級護甲數值", "當原有超級護甲條可見時，在小 BOSS 血條旁顯示超級護甲目前值 / 上限。預設關閉。",
                "BOSS 生命數值", "顯示 BOSS 血條的生命與護盾數值，包含獨立部位。預設開啟。",
                "BOSS 超級護甲數值", "具有超級護甲時，在 BOSS 血條下方顯示目前值 / 上限，包含獨立部位。預設關閉。",
            ...
            ["ko-KR"] = new[] {
                ...
                "미니보스 슈퍼 아머 수치", "기존 슈퍼 아머 바가 보일 때 미니보스 바 옆에 현재 / 최대 슈퍼 아머를 표시합니다. 기본값은 꺼짐입니다.",
                "보스 체력 수치", "개별 부위를 포함한 보스의 체력 바에 체력과 보호막 수치를 표시합니다. 기본값은 켜짐입니다.",
                "보스 슈퍼 아머 수치", "슈퍼 아머가 있을 때 보스 및 개별 부위의 체력 바 아래에 현재 / 최대 슈퍼 아머를 표시합니다. 기본값은 꺼짐입니다.",
            ...
            ["ja-JP"] = new[] {
                ...
                "ミニボスのスーパーアーマー数値", "元のスーパーアーマーバーが表示されているとき、ミニボスのバーの横に現在値 / 最大値を表示します。初期設定はオフです。",
                "ボスのHP数値", "独立した部位を含むボスのHPバーにHPとシールドの数値を表示します。初期設定はオンです。",
                "ボスのスーパーアーマー数値", "スーパーアーマーがあるとき、独立した部位を含むボスのHPバーの下に現在値 / 最大値を表示します。初期設定はオフです。",
            ...
            ["de-DE"] = new[] {
                ...
                "Superrüstungswerte von Minibossen", "Zeigt aktuelle / maximale Superrüstung neben Minibossleisten, wenn die ursprüngliche Superrüstungsleiste sichtbar ist. Standardmäßig aus.",
                ...
                "Superrüstungswerte von Bossen", "Zeigt bei aktiver Superrüstung den aktuellen / maximalen Wert unter Bossleisten, einschließlich einzelner Körperteile. Standardmäßig aus.",
            ...
            ["es-ES"] = new[] {
                ...
                "Superarmadura numérica de minijefes", "Muestra la superarmadura actual / máxima junto a las barras de minijefes cuando su barra original es visible. Desactivado por defecto.",
                ...
                "Superarmadura numérica de jefes", "Muestra la superarmadura actual / máxima bajo las barras de jefes, incluidas sus partes separadas, mientras tienen superarmadura. Desactivado por defecto.",
            ...
            ["fr-FR"] = new[] {
                ...
                "Super armure chiffrée des mini-boss", "Affiche la super armure actuelle / maximale près des barres des mini-boss lorsque sa barre d’origine est visible. Désactivé par défaut.",
                ...
                "Super-armure chiffrée des boss", "Affiche la super-armure actuelle / maximale sous les barres des boss, y compris leurs parties séparées, tant que la super-armure est active. Désactivé par défaut.",
            ...
            ["it-IT"] = new[] {
                ...
                "Super armatura numerica dei miniboss", "Mostra la super armatura attuale / massima accanto alle barre dei miniboss quando la barra originale è visibile. Disattivato per impostazione predefinita.",
                ...
                "Super armatura numerica dei boss", "Mostra la super armatura attuale / massima sotto le barre dei boss, incluse le parti separate, quando è attiva. Disattivato per impostazione predefinita.",
            ...
            ["pl-PL"] = new[] {
                ...
                "Liczbowy superpancerz minibossów", "Pokazuje bieżący / maksymalny superpancerz obok pasków minibossów, gdy widoczny jest jego oryginalny pasek. Domyślnie wyłączone.",
                "Liczbowe zdrowie bossów", "Pokazuje zdrowie i tarczę na paskach bossów, w tym oddzielnych części. Domyślnie włączone.",
                "Liczbowy superpancerz bossów", "Pokazuje bieżący / maksymalny superpancerz pod paskami bossów, w tym oddzielnych części, gdy superpancerz jest aktywny. Domyślnie wyłączone.",
            ...
            ["pt-BR"] = new[] {
                ...
                "Superarmadura numérica de minichefes", "Exibe a superarmadura atual / máxima ao lado das barras de minichefes quando a barra original está visível. Desativado por padrão.",
                "Vida numérica de chefes", "Exibe vida e escudo nas barras de chefes, incluindo partes separadas. Ativado por padrão.",
                "Superarmadura numérica de chefes", "Exibe a superarmadura atual / máxima abaixo das barras de chefes, incluindo partes separadas, enquanto a superarmadura estiver ativa. Desativado por padrão.",
            ...
            ["ru-RU"] = new[] {
                ...
                "Числа суперброни мини-боссов", "Показывает текущую / максимальную суперброню рядом с полосками мини-боссов, когда видна исходная полоска суперброни. По умолчанию выключено.",
                "Числа здоровья боссов", "Показывает здоровье и щит на полосках боссов, включая отдельные части. По умолчанию включено.",
                "Числа суперброни боссов", "Показывает текущую / максимальную суперброню под полосками боссов, включая отдельные части, пока суперброня активна. По умолчанию выключено.",
            ...
            ["sv-SE"] = new[] {
                ...
                "Superpansartal för minibossar", "Visar aktuellt / maximalt superpansar vid minibossars mätare när den ursprungliga superpansarmätaren syns. Av som standard.",
                "Hälsotal för bossar", "Visar hälsa och sköld på bossars mätare, inklusive separata delar. På som standard.",
                "Superpansartal för bossar", "Visar aktuellt / maximalt superpansar under bossars mätare, inklusive separata delar, medan superpansaret är aktivt. Av som standard.",
            ...
            ["th-TH"] = new[] {
                ...
                "ตัวเลขซูเปอร์อาร์เมอร์ของมินิบอส", "แสดงซูเปอร์อาร์เมอร์ปัจจุบัน / สูงสุดข้างแถบของมินิบอสเมื่อแถบซูเปอร์อาร์เมอร์เดิมปรากฏ ปิดไว้เป็นค่าเริ่มต้น",
                "ตัวเลขพลังชีวิตของบอส", "แสดงตัวเลขพลังชีวิตและโล่บนแถบของบอส รวมถึงชิ้นส่วนแยก เปิดไว้เป็นค่าเริ่มต้น",
                "ตัวเลขซูเปอร์อาร์เมอร์ของบอส", "แสดงซูเปอร์อาร์เมอร์ปัจจุบัน / สูงสุดใต้แถบของบอส รวมถึงชิ้นส่วนแยก ขณะมีซูเปอร์อาร์เมอร์ ปิดไว้เป็นค่าเริ่มต้น",
            ...
            ["tr-TR"] = new[] {
                ...
                "Mini boss süper zırh sayıları", "Asıl süper zırh çubuğu görünürken mini boss çubuklarının yanında mevcut / azami süper zırhı gösterir. Varsayılan olarak kapalıdır.",
                "Boss can sayıları", "Ayrı parçalar dahil boss çubuklarında can ve kalkan sayılarını gösterir. Varsayılan olarak açıktır.",
                "Boss süper zırh sayıları", "Süper zırh etkinken ayrı parçalar dahil boss çubuklarının altında mevcut / azami süper zırhı gösterir. Varsayılan olarak kapalıdır.",
