...
internal static class InventoryHardConstraintChecks
{
    ...
    private static void EditingAndPersistence()
    {
        ...
        Check(InventoryOptimizationPreferencesCodec.TryDecode("v3\nC|ICE|1|2", InventorySearchEffort.Fast, true, out var legacy) &&
            legacy.ComboPreferences.Single().Strength == InventoryConstraintStrength.Soft, "legacy config must stay soft");
