...
namespace SephiriaEnhancements.MultiplayerRules
{
    internal enum MultiplayerRuleId
    {
        ...
        ExplorationFloorHealingSupply,
        WanderingMerchantArtifactCandidateBonus,
        WanderingMerchantTabletCandidateCount,
        MerchantGuildArtifactCandidateBonus,
    ...
    internal static class MultiplayerRuleCatalog
    {
        private static readonly MultiplayerRuleDefinition[] Definitions =
        {
            ...
            D(MultiplayerRuleId.KrazBossHealthMultiplier, MultiplayerRuleUnit.Multiplier, 0.25f, 8f, 0.05f),
            ...
            D(MultiplayerRuleId.ExplorationFloorHealingSupply, MultiplayerRuleUnit.Toggle, 0f, 1f, 1f),
            D(MultiplayerRuleId.WanderingMerchantArtifactCandidateBonus, MultiplayerRuleUnit.Count, 0f, 8f, 1f),
            D(MultiplayerRuleId.WanderingMerchantTabletCandidateCount, MultiplayerRuleUnit.Count, 0f, 10f, 1f),
            D(MultiplayerRuleId.MerchantGuildArtifactCandidateBonus, MultiplayerRuleUnit.Count, 0f, 8f, 1f),
